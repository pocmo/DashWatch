...
public class ExtensionHost {
    ...
    public static final SparseArray<Operation> UPDATE_OPERATIONS = new SparseArray<Operation>();
    ...
    private static final String TAG = "DashWatch/DashClock/ExtensionHost";
